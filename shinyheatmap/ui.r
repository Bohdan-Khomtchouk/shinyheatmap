...
ui <- shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    selectInput("lowColor", "Low Value:", c("red", "blue", "purple", "green", "orange", "yellow", "white")),
    selectInput("midColor", "Mid Value:", c("none", "green", "blue", "purple", "red", "orange", "yellow", "white")),
    selectInput("highColor", "High Value:", c("blue", "orange", "yellow", "green", "red", "purple", "white")),    
